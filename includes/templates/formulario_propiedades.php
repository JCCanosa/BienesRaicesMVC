...
<fieldset>
    ...
    <label for="aparcamiento">Plazas parking:</label>
    <input type="number" id="aparcamiento" name="propiedad[aparcamiento]" placeholder="Ej: 3" min="1" max="9" value="<?php echo s($propiedad -> aparcamiento); ?>">
</fieldset>
<fieldset>
